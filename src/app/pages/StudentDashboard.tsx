          ...
          >
            {visibleCourses.map((course, index) => {
              ...
              return (
                ...
                >
                  <Link to={`/course/${course.id}`} className="block" aria-label={`View ${course.code} ${course.title}`}>
                  ...
                  <CardContent className="p-5 space-y-4">
                    <Link to={`/course/${course.id}`} className="block space-y-1" aria-label={`View ${course.code} ${course.title}`}>
